    ...
    <div
      ...
      <div
        ...
        style={{
          ...
          minHeight: '100%',
          padding: '60px 0 80px', transform: "translate3d(-96.1419px, -187.839px, 0px) scale(1)"
        }}>
...
function DCSection({ id, title, subtitle, children, gap = 48 }) {
  ...
  return (
    <div data-dc-section={sid} style={{ marginBottom: 80, position: 'relative', fontFamily: "\"Apple SD Gothic Neo\"" }}>
